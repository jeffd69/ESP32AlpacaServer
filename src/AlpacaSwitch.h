...
class AlpacaSwitch : public AlpacaDevice
{
    protected:
		...
		virtual void aGetCanAsync(AsyncWebServerRequest *request) = 0;
		virtual void aPutCancelAsync(AsyncWebServerRequest *request) = 0;
		...
		virtual void aPutSetAsync(AsyncWebServerRequest *request) = 0;
		virtual void aPutSetAsyncValue(AsyncWebServerRequest *request) = 0;
		...
		virtual void aGetStateChangeComplete(AsyncWebServerRequest *request) = 0;
